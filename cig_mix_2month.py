...
if __name__ == "__main__":
    ...
    # データ読み込み(2ヶ月分x2年)
    #
    filename = "CIG_RJFK_1112_train.csv"
    dat_train = pd.read_csv(filename)

    print(dat_train.head())
    
    filename = "CIG_RJFK_1112_test.csv"
    ...
    # write out models
    #
    pickle_name = "CIG_RJFK_1112_model.pkl"
    with open(pickle_name, 'wb') as fwrite:
    ...
    pp_df0.to_csv("conflevel_1112.csv", index=False)
