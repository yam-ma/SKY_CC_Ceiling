##
## 二ヶ月ごとのデータセットを作成する
##      訓練データだけでなく、テスト用のデータも二ヶ月ごとのものを作成する
...
if __name__ == "__main__":
    ...
    dat_test_0102.to_csv("CIG_RJFK_0102_test.csv", index=False)
    dat_test_0304.to_csv("CIG_RJFK_0304_test.csv", index=False)    
    dat_test_0506.to_csv("CIG_RJFK_0506_test.csv", index=False)
    dat_test_0708.to_csv("CIG_RJFK_0708_test.csv", index=False)    
    dat_test_0910.to_csv("CIG_RJFK_0910_test.csv", index=False)
    dat_test_1112.to_csv("CIG_RJFK_1112_test.csv", index=False)    
